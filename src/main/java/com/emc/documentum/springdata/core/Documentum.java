...
public class Documentum {
  ...
  public Documentum(UserCredentials credentials, String docBase, String docbrokerHost, String docbrokerPort)
      throws DfException {
  ...
  public IDfSession getSession() throws DfException {
    ...
    try {
      ...
      String msg = String.format(
          "Session cannot be instantiated for user %s for docBase %s. " + "Exception: %s, %s.", this.credentials.getUsername(), docBase, e.getClass(),
          e.getMessage()
      );
      logger.error(msg);
